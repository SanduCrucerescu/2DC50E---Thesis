namespace QuickSort3; // was not created I did it manually

using System;
using System.Collections.Generic;
/*
The EtdTListException class is defined as a custom exception class.
The TtdCompareFunc delegate is used to represent the comparison function.
The TDValidateListRange, QSS, TDQuickSortStd, and TDCompareLongint functions are implemented as static methods within the Program class.
The List<object> is used as the equivalent of TList in Delphi.
The Main method is the entry point of the program, where the list is created, populated, sorted, and the sorted elements are printed.
*/
