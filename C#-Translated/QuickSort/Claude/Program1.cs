...
static class Program
{
    ...
    static void QSS(IList<object> aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
        while (aFirst < aLast)
        {
    ...
    static void TDQuickSortStd(IList<object> aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
