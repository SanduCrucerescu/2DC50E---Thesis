namespace QuickSort1; // was not created I did it manually
...
static class Program
{
    ...
    internal static void QSS(IList<object> aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
        while (aFirst < aLast)
        {
    ...
    internal static void TDQuickSortStd(IList<object> aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
