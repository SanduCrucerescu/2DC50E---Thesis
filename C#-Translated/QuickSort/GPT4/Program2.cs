...
class Program
{
    ...
    static void TDValidateListRange(List<int> aList, int aStart, int aEnd, string aMessage)
    {
        if (aList == null)
        {
    ...
    static void QSS(List<int> aList, int aFirst, int aLast, Func<int, int, int> aCompare)
    {
        int L, R, pivot, temp;
        while (aFirst < aLast)
        {
    ...
    static void TDQuickSortStd(List<int> aList, int aFirst, int aLast, Func<int, int, int> aCompare)
    {
        TDValidateListRange(aList, aFirst, aLast, "TDQuickSortStd");
        QSS(aList, aFirst, aLast, aCompare);
    }

    static int TDCompareLongint(int aData1, int aData2)
    {
