...
class Program
{
    static void TDValidateListRange(ArrayList aList, int aStart, int aEnd, string aMessage)
    {
        if (aList == null)
    ...
    static void QSS(ArrayList aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
        int L, R;
        object Pivot, Temp;
        while (aFirst < aLast)
    ...
    static void TDQuickSortStd(ArrayList aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
