...
namespace QuickSort8.Test
{
    ...
    public class QuickSortTests
    {
        ...
        public void UnitTest_TDValidateListRange_ThrowsExceptionForNullList()
        {
            ...
            Assert.Throws<Exception>(() => Program.TDValidateListRange(list, 0, 0, "Test"));
        }
        ...
        public void UnitTest_TDValidateListRange_ThrowsExceptionForInvalidRange()
        {
            ...
            Assert.Throws<Exception>(() => Program.TDValidateListRange(list, -1, 2, "Test"));
            Assert.Throws<Exception>(() => Program.TDValidateListRange(list, 0, 3, "Test"));
            Assert.Throws<Exception>(() => Program.TDValidateListRange(list, 2, 1, "Test"));
        }
        ...
        public void FunctionalTest_TDQuickSortStd_SortsEmptyList()
        {
            ...
            Assert.Throws<Exception>(() => Program.TDQuickSortStd(list, 0, list.Count - 1, Program.TDCompareLongint));
        }
