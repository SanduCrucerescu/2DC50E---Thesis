...
namespace QuickSort6.Test
{
    ...
    public class QuickSortTests
    {
        ...
        {
            var list = new ArrayList() { 5, 876, 234, 9, 12, 44, 2 };
        ...
        public void UnitTest_TDValidateListRange_ThrowsExceptionForNullList()
        {
            ...
            Assert.Throws<EtdTListException>(() => Program.TDValidateListRange(list, 0, 0, "Test"));
        }
        ...
        public void UnitTest_TDValidateListRange_ThrowsExceptionForInvalidRange()
        {
            ...
            Assert.Throws<EtdTListException>(() => Program.TDValidateListRange(list, -1, 2, "Test"));
            Assert.Throws<EtdTListException>(() => Program.TDValidateListRange(list, 0, 3, "Test"));
            Assert.Throws<EtdTListException>(() => Program.TDValidateListRange(list, 2, 1, "Test"));
        }
        ...
        public void FunctionalTest_TDQuickSortStd_SortsEmptyList()
        {
            ...
            Assert.Throws<EtdTListException>(() => Program.TDQuickSortStd(list, 0, list.Count - 1, Program.TDCompareLongint));
        }

        [Test]
        public void FunctionalTest_TDQuickSortStd_SortsSingleElementList()
        {
            var list = new ArrayList() { 42 };
        ...
        {
            var list = new ArrayList() { 5, 4, 3, 2, 1 };
        ...
        {
            var list = new ArrayList() { 5, 2, 3, 2, 1, 4, 2 };
        ...
        {
            var list = new ArrayList() { -5, 2, -3, 0, 1, -4, 2 };
        ...
        {
            var list = new ArrayList() { 5, 5, 5, 5, 5 };
