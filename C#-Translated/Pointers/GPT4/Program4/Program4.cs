namespace Pointers9; // was not created I did it manually
...
class Program
{
    ...
    internal class TAddressBook
    {
        public List<TContact> Contacts = new List<TContact>();
        public int Count => Contacts.Count;
    }

    internal static void InitAddressBook(TAddressBook addressBook)
    {
        addressBook.Contacts.Clear();
    }

    internal static void FreeAddressBook(TAddressBook addressBook)
    {
        addressBook.Contacts.Clear();
    }

    internal static void AddContact(TAddressBook addressBook, string name, string email, string phoneNumber)
    {
    ...
    internal static TContact SearchContact(TAddressBook addressBook, string name)
    {
    ...
    internal static void RemoveContact(TAddressBook addressBook, string name)
    {
    ...
    internal static void PrintContacts(TAddressBook addressBook)
    {
        foreach (TContact contact in addressBook.Contacts)
        {
