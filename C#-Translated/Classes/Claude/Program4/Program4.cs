...
namespace TaskManagerApp4
{
    ...
    class TTaskList
    {
        ...
        {
            FTasks.Sort((left, right) => left.Priority.CompareTo(right.Priority));
        }
                ...
                switch (choice)
                {
                    ...
                    case 4:
                        ...
                        for (int i = 0; i < taskList.GetTaskCount(); i++)
                        {
                            ...
                            Console.WriteLine($"Index: {i}, Title: {task.Title}, Priority: {task.Priority}, Due Date: {task.DueDate:yyyy-MM-dd}, Completed: {task.Completed}");
                        }
                        break;
                    case 5:
