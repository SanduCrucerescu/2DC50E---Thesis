...
namespace Classes1
{
    ...
    public class ClassesTests
    {
        ...
        public void SetUp()
        {
            TObj = new TriangleObj(Classes1.ShapeType.Triangle, Classes1.TriangleType.Obtuse, width, height);
        }
        ...
        {
            TriangleObj TObj = new TriangleObj(Classes1.ShapeType.Triangle, Classes1.TriangleType.Obtuse, width, height);
