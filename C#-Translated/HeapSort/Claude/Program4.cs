...
{
    static void TDValidateListRange(IList<object> aList, int aStart, int aEnd, string aMessage)
    {
        if (aList == null)
    ...
    static void TDHeapSort(IList<object> aList, int aFirst, int aLast, TtdCompareFunc aCompare)
    {
