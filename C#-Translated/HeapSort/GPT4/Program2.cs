...
class Program
{
    ...
    delegate int TtdCompareFunc(object data1, object data2);
    ...
    static void HSTrickleDown(List<object> list, int fromIndex, int count, TtdCompareFunc compare)
    {
    ...
    static void HSTrickleDownStd(List<object> list, int fromIndex, int count, TtdCompareFunc compare)
    {
        object item = list[fromIndex];
        int childIndex = (fromIndex * 2) + 1;
        while (childIndex < count)
    ...
    static void TDHeapSort(List<object> list, int first, int last, TtdCompareFunc compare)
    {
