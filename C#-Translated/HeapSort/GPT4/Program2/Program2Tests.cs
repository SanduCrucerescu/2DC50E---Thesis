...
using static HeapSort7.Program;

namespace HeapSort7.Test
{
    [TestFixture]
    public class HeapSortTests
    {
        ...
        {
            List<object> arr = new List<object> { 10, 5, 8, 2, 1, 6, 3, 4, 7, 9 };
            Program.HSTrickleDown(arr, 0, arr.Count, Program.TDCompareLongint);
        ...
        {
            List<object> arr = new List<object> { 10, 5, 8, 2, 1, 6, 3, 4, 7, 9 };
            Program.HSTrickleDownStd(arr, 0, arr.Count, Program.TDCompareLongint);
